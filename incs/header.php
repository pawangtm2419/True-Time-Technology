<div class="header_bg">
    ...
    <div class="header">
      ...
      <div class="header_right col-md-8">
        <div class="col-md-12 right-header">
          ...
          <div class="col-md-10 header-links">
            <ul>
              <li><a href="#">
                  <?php 
                    if($_SESSION['custFname']) { echo "Welcome -"; echo $_SESSION['custFname']; } 
                  ?>
                </a></li>
              <?php
                $FotrQuery = mysql_query("select * from pgs where manucatg='headerTop' order by id desc LIMIT 3");
                 while($FotrQuery1 = mysql_fetch_array($FotrQuery)) {
                   ?>
                    <li>
                      <a href="pages.php?pgid=<?php echo $FotrQuery1['id']; ?>"><?php echo str_replace('_', ' ', $FotrQuery1['pagenmae']); 
                      ?>
                      </a></li>
                    <?php }?>
              <?php
        ...
        <div class="col-md-12 search-area">
          ...
          <div class="col-md-2 nopadding registers pull-right">
            <div class="social-icons">
              <a href="#" target="_blank"><img src="http://truetimetechnology.in/images/social/insta.png"
                  alt="Instagram" title="facebook"></a>
              <a href="#" target="_blank"><img src="images/social/fb.jpg" alt="facebook" title="facebook"></a>
              <a href="#" target="_blank"><img src="images/social/twitter.jpg" alt="facebook" title="facebook"></a>
              <a href="#" target="_blank"><img src="images/social/linkdin.PNG" alt="facebook" title="facebook"></a>
            </div>
          </div>
          <div class="col-md-2 nopadding registers pull-right countItems" style="display:none;">
            <div class="social-icons">
              <a href="#" target="_blank"><img src="images/social/fb.jpg" alt="facebook" title="facebook"></a> <a
                href="#" target="_blank"><img src="images/social/twitter.jpg" alt="facebook" title="facebook"></a> <a
                href="https://www.linkedin.com/home?trk=nav_responsive_tab_home" target="_blank"><img
                  src="images/social/linkdin.PNG" alt="facebook" title="facebook"></a>
            </div>
          </div>
    ...
    <div class="container-fluid">
      <ul class="megamenu skyblue">
        ...
        <?php 
			...
			?>
        <li class="grid">
          <a style="width:100%;" href="products.php?catg=<?php echo $selectcategory1['category'];?>">
            <?php echo str_replace("_"," ",$selectcategory1['category']); ?>
          </a>
          <!--dropdown-->
          ...
          <div class="col1" style="width:100%;">
            <div class="h_nav" style="width:100%;">
              <?php 
						...
						{ ?>
        <li><a
            href="products.php?catg=<?php echo $selectsubcategory1['category'];?>&&subcatg=<?php echo $selectsubcategory1['sub_category'];?>&&titleurl=<?php echo $selectsubcategory1['title_url'];?>"
            style="width:100%;">
            <?php echo str_replace("_"," ",$selectsubcategory1['sub_category']); ?>
          </a></li>
        <?php } echo "</ul>"; ?>
    </div>
  </div>
  ...
  <?php
		    ...
		    $selectmenupgs = mysql_query("select * from pgs where manucatg='$menuCat' AND status = '1' order by id asc LIMIT 2");
			 ...
			 {?>
  <li><a href="pages.php?pgid=<?php echo $selectmenupgs1['id']; ?>">
      <?php echo $selectmenupgs1['pagenmae']; ?>
    </a></li>
  <?php } ?>
