          ...
          <!--- ================== content ================== -->
            <div class="products">
                    <div class="filters">
                     <?php
					     $proCount = 0;	 
					     $coutQuery = mysql_query("select * from product where category ='$srchkey' or sub_category ='$srchkey' or product_name ='$srchkey' order by id desc");
						 while($coutQuery1 = mysql_fetch_array($coutQuery))
						 {
						 $proCount +=1;
						 }
					?>
                        <a href="#"><h4>Your search key - <?php echo $srchkey; ?> </span> </h4></a>
                            <ul class="w_nav">
					...
					<!--search by category -->
                            <?php
                            $proQuery = mysql_query("select * from product where category ='$srchkey' or sub_category ='$srchkey' or product_name ='$srchkey'");	
                            ...
                            <div class="grid1_of_4">
                                <div class="content_box"> 
                                  <div class="view view-fifth">
                                     ...
                                     <img src="images/products/<?php echo $proQuery1['category'];?>/<?php echo $proImg;?>/250+250_<?php echo $proQuery1['product_image'];?>" class="lazyOwl" alt="<?php echo $proQuery1['product_image'];?>"/>
                                     </a>
                                   </div>
                                   <div class="image-caption">
                                      <h3 class="owl-title"><a href="product-detail.php?product_id=<?php echo $proQuery1['id'];?>"><?php echo $proQuery1['product_name'];?></a></h3>
                                      <div class="meta">
                                         <div class="detail"><?php echo $proQuery1['overview'];?></div>
                                         <div class="price"><i class="fa fa-rupee"></i> <?php echo $proQuery1['sale_price'];?></div>
                                         <div class="regprice"><i class="fa fa-rupee"></i> <?php echo $proQuery1['reg_price'];?></div>
                                      </div>  
                                      <div class="owl-carousel-btn">
                                       <a href="contact-us.php" class="btn read-more btn-sm btn-primary">View Detail</a>
                                      </div>
