...
if( isset( $_POST["delete"] ) ) {
   ...
   {
   $deletequery = mysql_query("delete from category where id = '$idd'");
...
if($id)
{
$deletequery = mysql_query("delete from category where id = '$id'");
header("Location:category-mgmt.php");
}
?>
<div class="holder">
  ...
  <ul>
    ...
    <li><a href="add-edit-subcategory.php?action=add">Add Subcategory</a></li>
            ...
            <form name="frm1" method="post">
                ...
                <span class="date"><label></label><a href="#" onclick="chunchall(this);return false" style="color:#FFFFFF;">Check all</a></span>
                <span class="block" style="width:425px; ;">Category</span>
	    ...
	    ?>
            <div class="grid-box-data" style="width:898px;float:right;">
                ...
                <span class="block" style="width:425px; ;">
              ...
              <div class="apply-icons-1" style="width:7%;">
                 <ul>
                        <li><a href="add-edit-category.php?action=edit&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/edit-icon.png" alt="Edit" title="Edit" /></a></li>
                        <li><a href="category-mgmt.php?id=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left;"><img src="images/delate-icon.png" alt="Delete" title="Delete" /></a></li>
                         </ul>
    </div></div>
