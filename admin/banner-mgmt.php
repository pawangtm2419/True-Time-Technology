...
if( isset( $_POST["delete"] ) ) {
   ...
   {
   $deletequery = mysql_query("delete from banner where id = '$idd'");
...
if($id)
{
$deletequery = mysql_query("delete from banner where id = '$id'");
header("Location:banner-mgmt.php");
}
$act = $_REQUEST['act'];
if($act)
{
$updatestatus = mysql_query("update banner set status = '0' where id = '$act'");
}
$dact = $_REQUEST['dact'];
if($dact)
{
$updatestatus = mysql_query("update banner set status = '1' where id = '$dact'");
}
?>
<div class="holder">
  ...
  <ul>
    ...
    <li><a href="add-edit-banner.php?action=add">Add Banner</a></li>
            ...
            <form name="frm1" method="post">
                ...
                <span class="block" style="width:50px; ;">Banner</span>
	    ...
	    ?>
            <div class="grid-box-data" style="width:898px;float:right;">
                ...
                <span class="block" style="width:50px; ;">
                  <img src="../images/banner/800+400_<?php echo $select[$i]["banner"]; ?>" height="20px" width="40px" /></span>
              ...
              <div class="apply-icons-1" style="width:12%;">
                 <ul>
                        <li><a href="add-edit-banner.php?action=edit&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/edit-icon.png" alt="Edit" title="Edit" /></a></li>
                        <li><a href="banner-mgmt.php?id=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left;"><img src="images/delate-icon.png" alt="Delete" title="Delete" /></a></li>
                        <?php if($select[$i]["status"]==1){?>
                        <li><a href="banner-mgmt.php?act=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left; text-decoration:none;">ACTIVE</a></li><?php } else {?>
                        <li><a href="banner-mgmt.php?dact=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left; text-decoration:none;">INACTIVE</a></li>
                        <?php } ?>
                         </ul>
    </div></div>
