...
if( isset( $_POST["delete"] ) ) {
   ...
   {
   $deletequery = mysql_query("delete from subcategory where id = '$idd'");
...
if($id)
{
$deletequery = mysql_query("delete from subcategory where id = '$id'");
header("Location:subcategory-mgmt.php");
}
?>
<div class="holder">
...
?>
 ...
 <div class="menu_box" >
  <ul>
    ...
    <li><a href="subcategory-mgmt.php">Manage Sub Category</a></li>
    <li><a href="add-edit-subcategory.php?action=add">Add Sub Category</a></li>
  </ul>
 </div> 
            <form name="frm1" method="post">
                ...
                <span class="block" style="width:200px; ;">Category</span>
                <span class="block" style="width:225px; ;">Sub Category</span>
	    ...
	    ?>
            <div class="grid-box-data" style="width:898px;float:right;">
              ...
              <span class="block" style="width:225px;" ><?php echo $select[$i]["subcategory"];?></span>
              ...
              <div class="apply-icons-1" style="width:7%;">
                 <ul>
                        <li><a href="add-edit-subcategory.php?action=edit&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/edit-icon.png" alt="Edit" title="Edit" /></a></li>
                        <li><a href="subcategory-mgmt.php?id=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left;"><img src="images/delate-icon.png" alt="Delete" title="Delete" /></a></li>
                         </ul>
    </div></div>
