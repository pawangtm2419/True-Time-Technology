...
if( isset( $_POST["delete"] ) ) {
   ...
   {
   $deletequery = mysql_query("delete from social where id = '$idd'");
...
if($id)
{
$deletequery = mysql_query("delete from social where id = '$id'");
header("Location:social-mgmt.php");
}
$act = $_REQUEST['act'];
if($act)
{
$updatestatus = mysql_query("update social set status = '0' where id = '$act'");
}
$dact = $_REQUEST['dact'];
if($dact)
{
$updatestatus = mysql_query("update social set status = '1' where id = '$dact'");
}
?>
<div class="holder">
  ...
  <ul>
    ...
    <li><a href="add-edit-social.php?action=add">Add Social Link</a></li>
            ...
            <form name="frm1" method="post">
                ...
                <span class="block" style="width:300px; ;">Link</span>
	    ...
	    ?>
            <div class="grid-box-data" style="width:898px;float:right;">
                ...
                <span class="block" style="width:50px; ;">
                  <img src="../images/social/<?php echo $select[$i]["image"]; ?>" height="50px" width="50px" /></span>
              <span class="block" style="width:300px;" ><?php echo $select[$i]["social_link"];?></span>
              ...
              <div class="apply-icons-1" style="width:12%;">
                 <ul>
                        <li><a href="add-edit-social.php?action=edit&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/edit-icon.png" alt="Edit" title="Edit" /></a></li>
                        <li><a href="social-mgmt.php?id=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left;"><img src="images/delate-icon.png" alt="Delete" title="Delete" /></a></li>
                         <?php if($select[$i]["status"]==1){?>
                        <li><a href="social-mgmt.php?act=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left; text-decoration:none;">ACTIVE</a></li><?php } else {?>
                        <li><a href="social-mgmt.php?dact=<?php echo $select[$i]["id"];?>" style="background-image: none;float:left; text-decoration:none;">INACTIVE</a></li>
                        <?php } ?>
                         </ul>
    </div></div>
